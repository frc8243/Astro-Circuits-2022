...
public class RobotContainer {
  ...
  private void configureButtonBindings() {
    ...
    new JoystickButton(xboxController1, XboxConstants.RIGHT_BUMPER).whenPressed(new ArmUp(m_armSystem));                                                                                                 
    new JoystickButton(xboxController1, XboxConstants.LEFT_BUMPER).whenPressed(new ArmDown(m_armSystem));
  }
