...
public class RobotContainer {
  ...
  private void configureButtonBindings() {
    ...
    new JoystickButton(xboxController1, XboxConstants.RIGHT_BUMPER).whenPressed(
        new ConditionalCommand(new ArmUp(m_armSystem), new PrintCommand("Arm Already Up"), m_armSystem::armIsDown),
        false);
    new JoystickButton(xboxController1, XboxConstants.LEFT_BUMPER).whenPressed(
        new ConditionalCommand(new ArmDown(m_armSystem), new PrintCommand("Arm Is Already Down"), m_armSystem::armIsUp),
        false);
  }
